...
export const products: Product[] = [
  {
    ...
    category: 'Steel Rods',
    shortDescription: 'High-tensile thermo-mechanically treated steel rod for concrete reinforcement.',
    description: 'Our premium 8mm TMT Steel Rods are manufactured using the latest thermo-mechanical treatment technology that ensures optimal strength and ductility. These rods feature a harder outer layer with a softer core, providing excellent seismic resistance and bendability. Ideal for all types of RCC (Reinforced Cement Concrete) structures.',
    price: 950,
    unit: 'per quintal',
    imageUrl: 'https://images.pexels.com/photos/2657063/pexels-photo-2657063.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    inStock: true,
    specifications: {
  ...
  },
  {
    ...
    shortDescription: 'Corrosion-resistant galvanized iron sheet for roofing and industrial applications.',
    description: 'Our 1mm Galvanized Iron Sheets are coated with a protective layer of zinc that provides excellent resistance against corrosion and oxidation. These sheets are known for their durability, formability, and weather resistance, making them ideal for various construction and industrial applications.',
    price: 2200,
    unit: 'per sheet',
    imageUrl: 'https://images.pexels.com/photos/2932211/pexels-photo-2932211.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    inStock: true,
    specifications: {
  ...
  },
  {
    ...
    category: 'Iron Bars',
    shortDescription: 'Structural mild steel angle for framework and support applications.',
    description: 'Our 50x50x6mm Mild Steel Angles are L-shaped structural steel products that offer excellent strength and versatility. These angles are hot-rolled and feature equal legs, making them perfect for framing, bracing, and support applications. Their high strength-to-weight ratio ensures reliable performance in various construction and engineering projects.',
    price: 780,
    unit: 'per meter',
    imageUrl: 'https://images.pexels.com/photos/1251176/pexels-photo-1251176.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    inStock: true,
    specifications: {
  ...
  },
  {
    ...
    shortDescription: 'Structural steel I-beam for heavy load-bearing applications in construction.',
    description: 'Our ISMB 150 Steel I-Beams are high-strength structural components with an I-shaped cross-section that provides exceptional load-bearing capacity. These beams feature parallel flanges connected by a central web, offering superior resistance to bending and deflection. Ideal for major structural applications in buildings, bridges, and industrial structures.',
    price: 3600,
    unit: 'per meter',
    imageUrl: 'https://images.pexels.com/photos/244954/pexels-photo-244954.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    inStock: true,
    specifications: {
  ...
  },
  {
    ...
    category: 'Metal Sheets',
    shortDescription: 'Durable corrugated metal sheet for industrial and residential roofing.',
    description: 'Our 0.6mm Corrugated Roofing Sheets provide excellent strength and weather resistance for all roofing applications. The corrugated profile enhances structural integrity while maintaining lightweight properties. These sheets are available in galvanized or color-coated finishes, offering superior protection against corrosion along with aesthetic appeal.',
    price: 520,
    unit: 'per sq. meter',
    imageUrl: 'https://images.pexels.com/photos/1714338/pexels-photo-1714338.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    inStock: true,
    specifications: {
  ...
  },
  {
    ...
    category: 'Structural Beams',
    shortDescription: 'Mild steel C-channel for structural support and framing applications.',
    description: 'Our 100x50x5mm Mild Steel Channels are versatile C-shaped structural members ideal for numerous construction and fabrication applications. These channels feature excellent strength-to-weight ratio and are widely used in structural frameworks. The standardized dimensions ensure compatibility with other structural components, while the mild steel composition provides good weldability and machinability.',
    price: 860,
    unit: 'per meter',
    imageUrl: 'https://images.pexels.com/photos/3850647/pexels-photo-3850647.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    inStock: true,
    specifications: {
      material: 'Mild Steel (IS:2062)',
  ...
  },
  {
    ...
    category: 'Metal Sheets',
    shortDescription: 'Lightweight, corrosion-resistant aluminum sheet for industrial applications.',
    description: 'Our 3mm Aluminum Sheets combine lightweight properties with excellent corrosion resistance and formability. These sheets are suitable for various applications requiring a good strength-to-weight ratio. Available in different alloy grades and tempers, our aluminum sheets can be customized to meet specific requirements for hardness, formability, and mechanical properties.',
    price: 3200,
    unit: 'per sheet',
    imageUrl: 'https://images.pexels.com/photos/1485560/pexels-photo-1485560.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    inStock: true,
    specifications: {
